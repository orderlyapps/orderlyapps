...
import { AvAssignmentList, AvSmsSettingsModal } from "@amodeo/proclaimer/feature/av";
  ...
  return (
    <IonPage>
      <IonHeader>
        ...
        <AvSmsSettingsModal is_open={settings_open} on_dismiss={() => set_settings_open(false)} />
      </IonHeader>
