...
import { ministerialServantPermissionCollection } from "../collections/ministerial-servant-permission.ts";
import { congregationAdminCollection } from "../collections/congregation-admin.ts";
