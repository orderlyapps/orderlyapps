...
import { midweekAVAssignmentIDs, avAssignmentLabels } from "@amodeo/proclaimer/feature/av";
...
export function MidweekAssignmentsDisplay({ week_id }: MidweekAssignmentsDisplayProps) {
