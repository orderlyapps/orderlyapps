...
import { useLocalSpeakers } from "./use-local-speakers.ts";
import {
  congregationCollection,
  useStoredCongregation,
} from "@amodeo/proclaimer/feature/congregation";
import { outlineCollection } from "../collections/outline.ts";
import { speakerAssignmentCollection } from "../collections/speaker-assignment.ts";
import { speakerOutlineCollection } from "../collections/speaker-outline.ts";
...
import type { Outline } from "../schemas/outline.ts";
import type { SpeakerAssignment } from "../schemas/speaker-assignment.ts";
import type { SpeakerOutline } from "../schemas/speaker-outline.ts";
